		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-6 text-center mb-5">
					<h2 class="heading-section">Let's stand away Covis-19 from us</h2>
				</div>
			</div>
			...
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex">
						<div class="img" style="background-image: url(images/9.png);">
			      </div>
						<div class="login-wrap p-4 p-md-5">
			      	<div class="d-flex">
			      		<div>
			      			<h3 class="mb-4">Safty Notice </h3>
							
							  <p>We are taking  aggresive messures To minimize this outbreak within our premises during these period....
								 
							  </p>
					<p>
						1)Limited Number of consultants currently Working in clinics...
					</p>

							  <p>
						2)We have limited number of appointments that could accept within time frame...
					</p>

							  <p>
						3)There might be a delay on processing your Appoinment...
